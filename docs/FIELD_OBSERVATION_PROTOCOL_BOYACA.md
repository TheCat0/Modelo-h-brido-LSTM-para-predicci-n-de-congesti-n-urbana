...
Este documento describe cómo una futura campaña de campo podría recopilar variables compatibles con el conjunto de datos sintético `traffic_observations_boyaca_guayaquil_2026.csv`. El CSV incluido en el repositorio es didáctico: no demuestra que esta campaña haya sido realizada ni constituye evidencia municipal oficial.
...
El conjunto de datos sintético concentra sus máximos de demanda en esas franjas para facilitar pruebas del modelo.
...
Este protocolo y el conjunto de datos asociado tienen propósito educativo y de código abierto. No constituyen certificación oficial, estudio de impacto vial ni recomendación de política pública.
