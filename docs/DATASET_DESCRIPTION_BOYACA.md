# Conjunto de datos didáctico sintético: calle Boyacá, Guayaquil (2026)
...
6. El conjunto de datos no debe emplearse para decisiones operativas, regulación o planificación urbana.
